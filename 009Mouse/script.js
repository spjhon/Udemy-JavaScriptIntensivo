...
// este es el ancho y alto de la pantalla apenas se ejecuta
let windowWidth = window.innerWidth;
let windowHeight = window.innerHeight;

//esta funcion es para obtener el alto y el ancho cuando
//se modifique la pantalla
function definirTamaPantalla() {
  windowWidth = window.innerWidth;
  windowHeight = window.innerHeight;
}

//en esta funcion es donde se esta capturando cada uno de las
//coordenadas, la e es el event object, y cada vez
//que se mueva el mouse se ejecuta la funcion seguir.
